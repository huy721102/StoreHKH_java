...
import com.example.storehkh.adapters.SliderAdapter;
...
public class OnBoardingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //HIDE toolbar
        //getSupportActionBar().hide(); nên tìm hiểu lại đoạn code này
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(OnBoardingActivity.this,DangkyActivity.class));
                finish();
            }
        });
